...
import { confirmRecognitionMemory, probeRecognitionPipeline, recognizePokemonCard, shutdownCardRecognition, imageRecognitionEnabled, imageRecognitionPreferenceEvent, type RecognitionPipelineKind } from "@/lib/card-recognition-local";
