...
const sheets: [Table, string, [string, string][]][] = [
  ...
  ["auctions", "Leilões", [["ID","id"],["Carta","card_name"],["ID carta","card_id"],["Status","status"],["Inicial","starting_price"],["ARREMATE","buyout_price"],["Vencedor","participant_name"],["WhatsApp vencedor","participant_whatsapp"],["Telefone vencedor","participant_phone"],["Valor final","final_price"],["Tipo de vitória","win_type"],["Início","started_at"],["Prazo","scheduled_end_at"],["Fim","ended_at"]]],
  ["bids", "Lances", [["ID","id"],["Leilão","auction_id"],["Participante","participant_name"],["WhatsApp","participant_whatsapp"],["Telefone","participant_phone"],["Valor","amount"],["Tipo","kind"],["Status","status"],["Confirmado em","processed_at"],["Ordem","confirmation_order"],["Evento externo","whatsapp_event_id"],["Substituído por","replaced_by"]]],
  ["purchases", "Compras", [["ID","id"],["Leilão","auction_id"],["Carta","card_name"],["Comprador","participant_name"],["WhatsApp comprador","participant_whatsapp"],["Telefone comprador","participant_phone"],["Valor","amount"],["Status","status"],["Confirmada em","confirmed_at"]]],
    ...
    for (const [table, title, columns] of sheets) {
      ...
      for (const row of data[table]) {
        ...
        const enriched = {
          ...
          participant_phone: person?.phone_e164 ?? "",
        };
